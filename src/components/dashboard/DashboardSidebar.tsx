      ...
      <div className="p-3 border-t border-sidebar-border space-y-1">
        <Link
          ...
          className={cn(
            ...
            location.pathname === "/dashboard/profile" && "bg-sidebar-primary text-sidebar-primary-foreground"
          )}
        >
        ...
        {isAdmin && (
          <Link
            ...
            className={cn(
              "flex items-center gap-3 px-3 py-2.5 rounded-lg text-sidebar-foreground hover:bg-sidebar-accent transition-colors",
              location.pathname === "/dashboard/settings" && "bg-sidebar-primary text-sidebar-primary-foreground"
            )}
          >
