  ...
  public: {
    Tables: {
      ...
      ai_usage_tracking: {
        ...
        Relationships: [
          {
            foreignKeyName: "ai_usage_tracking_workspace_id_fkey";
            columns: ["workspace_id"];
            isOneToOne: false;
            referencedRelation: "workspaces";
            referencedColumns: ["id"];
      ...
      meta_webhook_logs: {
        ...
        Relationships: [
          {
            foreignKeyName: "meta_webhook_logs_workspace_id_fkey";
            columns: ["workspace_id"];
            isOneToOne: false;
            referencedRelation: "workspaces";
            referencedColumns: ["id"];
          ...
          {
            foreignKeyName: "meta_webhook_logs_connection_id_fkey";
            columns: ["connection_id"];
            isOneToOne: false;
            referencedRelation: "whatsapp_connections";
            referencedColumns: ["id"];
